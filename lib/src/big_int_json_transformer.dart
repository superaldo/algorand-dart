import 'big_int_json_reader.dart';
import 'big_int_json_writer.dart';
...
class BigIntJsonTransformer extends DefaultTransformer {
  BigIntJsonTransformer._({required JsonDecodeCallback jsonDecodeCallback})
  ...
  factory BigIntJsonTransformer({List<String>? keys}) {
    return BigIntJsonTransformer._(
      jsonDecodeCallback: (responseBody) {
        return decode(responseBody, keys: keys);
      },
    );
  }

  /// Parses the string and returns the resulting Json object.
  static dynamic decode(String source, {List<String>? keys}) {
    Object? value;
  ...
  static dynamic encode(Object? value, {StringSink? sink, String? indent}) {
